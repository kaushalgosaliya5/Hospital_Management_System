 ...
 */
public class DBHelperL extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "MESSAGES_DBL";
    private static  final int DATABASE_VERSION = 1;

    // TABLE NAME
    private static final String TABLE_MESSAGES = "Patient";

    // COLUMN NAME - Table Messages
    private static  final String KEY_ID = "id";
    private static final String KEY_NAME = "Name";
    private static  final String KEY_USER_NAME = "Gender";
    private static final String KEY_PASSWORD = "Doctor";
    private static final String KEY_MOBILE = "Prescription";
    private static final String KEY_USER_TYPE = "LabTest";
    ...
    public ArrayList<MessageModel> readAllMessages(){
        ...
        selectQuery = "SELECT * FROM " + TABLE_MESSAGES + " WHERE LabTest != '' ";
